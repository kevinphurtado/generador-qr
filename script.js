document.addEventListener("DOMContentLoaded", () => {
    ...
    const injectModals = () => {
       ...
       const populateCountryCodes = (selectId) => {
        ...
        if (select && select.options.length === 0) { // Poblar solo si está completamente vacío
        ...
        if (e.target.classList.contains('generate-qr-button')) {
            ...
            switch(type) {
                ...
                case 'instagram':
                    ...
                    break;
                case 'whatsapp':
                    // ✅ **NUEVO:** Lógica para usar el selector de país en WhatsApp
    ...
    // --- INITIALIZATION ---
    injectModals();
    // ✅ **CORREGIDO:** Poblar las listas de países una sola vez al cargar la página
